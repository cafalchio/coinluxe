...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--save_pics', type=str, help='To just save pics, run --save_pics True')
    ...
    def save_images(self, image_url, coin_id):
        ...
        image_name = os.path.join("/home/cafalchio/Projects/coinluxe/media/coin_images", name)
    ...
    def handle(self, *args, **options):
        ...
        for i in range(1, 5):
            ...
            if response.status_code == 200:
                ...
                logger.warning(f" Error connecting to coingecko for page {i}, please try later")
            time.sleep(10)
